...
public class Search_fragment_volonter extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_search_volonter, container, false);
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                switch (filter.getSelectedItem().toString()) {
                    case "Все мероприятия": {
                        /*query.whereEqualTo("Name", "football");
